...
translate chinese strings:
    ...
    new "{u}填写问卷，在不加载保存的情况下玩第[FLSS.week.cur]周{/u}"
    ...
    new "你的设备无法保存不同周的游戏进度。请按照指示来解决这个问题。"
    ...
    new "2. 转到 - \"C:/Users/username/AppData/Roaming/RenPy/persistent/\"文件夹。"


    old "3. Create a backup of the file \"FetishLocator\" and delete it."
    new "3. 备份文件\"FetishLocator\"，并删除原文件。"
    ...
    new "5. 启动一次游戏后，你可以把备份的\"FetishLocator\"文件放回原位置，以获得上周的游戏存档。"
    ...
    new "本游戏性趣探测器适合\n18岁或以上人士。请遵守当地法律。\n所有游戏人物均为18岁或以上年龄，无一例外。\n性趣探测器中的游戏人物探索两性关系和性行为的方式，有健康的，也有不健康的。其中有些内容可能会对某些玩家造成冒犯。建议观众谨慎观看。为此，游戏许多内容都是可选的，且往往有多种路径可供选择。这对剧情来说是必要的。游戏中探讨的内容不应被视为对特定性癖、嗜好或行为模式的认可。请您负责任地探索自己的两性关系和性行为模式。\n\n祝您玩得愉快！"
