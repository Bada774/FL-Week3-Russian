translate deutsch strings:
    ...
    new "Du hast Ende #{} freigeschaltet"


    old "You've unlocked a new CG Gallery"
    new "Du hast eine neue CG-Galerie freigeschaltet"


    old "You can watch the scene again in the Replay Room"
    new "Du kannst die Szene im Replay Room noch einmal ansehen"
    ...
    new "Du kannst nur zwei von Min, Lyssa oder Maria auswählen"
