...
translate french d16s05_7a5532ea:
    ...
    mct "Je me demande ce qui est mince—"
...
translate french d16s05_c1f733bb:
    ...
    sy "Sans oublier que si tu tenais vraiment à la vie privée, tu aurais frappé."
...
translate french d16s05_aaa5766b:
    ...
    sy "Ugh, je dois pisser. Je savais que je n'aurais pas dû boire cette deuxième tasse de café."
...
translate french d16s05_cb15f7a6:
    ...
    mc "Je sais que nous sommes...{i}plus{/i} que nous l'étions avant maintenant."


translate french d16s05_41e4ea68:


    mc "Et c'est excitant."


translate french d16s05_ba6638e0:


    mc "Mais en même temps, nous devons procéder étape par étape."


translate french d16s05_2d160d94:


    mc "La société n'apprécie pas vraiment... ce que nous faisons."
...
translate french d16s05_c63def3f:
    ...
    sy "Je tiens à toi et, à ma connaissance, tu tiens à moi."


translate french d16s05_dbfcac96:


    sy "C'est tout ce qui compte."
...
translate french d16s05_7e23f439:
    ...
    mc "*Rires* Je suis d'accord, mais quand même."
...
translate french d16s05_b8900318:
    ...
    mc "Stacy, je tiens à toi. Je ne veux pas te faire de mal."


translate french d16s05_44581e0a:


    mc "Je ne sais pas ce qui pourrait arriver, je veux juste que nous soyons prudents."


translate french d16s05_872f21af:


    sy "*Soupir* Je... comprends ce que tu essaies de faire."


translate french d16s05_8ab5ae4f:


    sy "Mais je n'aime pas ça. Mais je comprends."
...
translate french d16s05_90a342fc:
    ...
    mc "Des règles pour toi, mais pas pour moi."


translate french d16s05_b5fa82b7:


    mc "Je plaisante. Merci. Je suis heureux que tu comprennes."
...
translate french d16s05_7adf0993:
    ...
    mc "Notre fameux gouvernement rapide au travail, mesdames et messieurs."


translate french d16s05_408c2c0a:


    sy "J'ai l'impression de vieillir des années à chaque seconde."


translate french d16s05_91b3f912:


    mc "Oh, calme-toi, reine du drame. Cela ne fait littéralement que 15 minutes."
...
translate french d16s05_82b03971:
    ...
    mc "Tiens, bois ça. Apparemment, c'est plus difficile de s'inquiéter quand on a quelque chose dans la bouche."
...
translate french d16s05_165c3630:
    ...
    sy "Je ne sais pas. C'est difficile à expliquer."


translate french d16s05_2a31549c:


    sy "C'est comme si... j'aime la technologie, mais je déteste un peu la culture."


translate french d16s05_1bbb82ce:


    sy "Je voulais donc quelque chose qui soit lié à la technologie, mais loin de toute cette bulle."


translate french d16s05_b086d03e:


    sy "Et puis c'est comme je l'ai dit. J'ai vu le dépliant, j'ai pensé que ça pourrait être quelque chose, et maintenant nous y sommes. J'attends toujours..."
...
translate french d16s05_65a76881:
    ...
    mc "Hm. C'est bon à savoir."


translate french d16s05_e370279e:


    mc "Je me demande si notre... situation va être un problème."
...
translate french d16s05_382815eb:
    ...
    mc "Eh bien, c'est un travail fédéral. Ils vérifient les antécédents et tout ça."


translate french d16s05_2fc07473:


    sy "Ouais, mais ce n'est pas comme si nous faisions tout exploser pour que tout le monde puisse le voir."


translate french d16s05_bdb7e1b3:


    sy "Littéralement... seules trois personnes dans le monde entier nous connaissent. Deux d'entre elles sont nous.{w} Je suis sûr que tout ira bien."
...
translate french d16s05_211e3808:
    ...
    sy "...C'est la réponse la plus sèche qui soit."
...
translate french d16s05_ab33ffd2:
    ...
    sy "De plus, son ambiance de dom bienveillante est impeccable."
...
translate french d16s05_da626596:
    ...
    mc "Tout ce que je dirai, c'est que tout va bien."


translate french d16s05_6abc3f50:


    mc "Tous les détails épicés qui peuvent exister ou non ne seront connus qu'entre elle et moi, et c'est tout."
...
translate french d16s05_4f9e374a:
    ...
    sy "Oh mon Dieu, d'accord. J'ai compris. Souhaites-moi bonne chance."


translate french d16s05_ee40ef6b:


    mc "Hé, je suis fier de toi. Tu as compris."
...
translate french d16s05_53fdf96d:
    ...
    sy "Euh, d'accord, merci, au revoir."
...
translate french d16s05_304c149c:
    ...
    mc "Ouais, c'est plutôt ennuyeux."
...
translate french d16s05_407cebc9:
    ...
    sy "J'ai dû me pencher sous 17 angles différents pour pisser dans la tasse sans me pisser dessus en public."
...
translate french d16s05_d0356af7:
    ...
    sy "Je le jure devant Dieu, c'était la merde la plus stupide qui soit."
...
translate french d16s05_4967428d:
    ...
    sy "Le salaire est... bien, je suppose. Vivable."


translate french d16s05_a6c59dd0:


    sy "Je ne sais pas. Je vais devoir dormir dessus."


translate french d16s05_b6ac60e5:


    sy "Ugh, j'ai hâte d'avoir mon propre truc."
...
translate french d16s05_12c0c1df:
    ...
    mc "Eh bien, tu dois commencer quelque part."


translate french d16s05_12cb10ae:


    mc "Je suis sûr que tu dirigeras le département d'ici la fin du mois."


translate french d16s05_3b7b82e8:


    sy "Ugh, ils ne vous disent pas à quel point les entretiens sont épuisants."


translate french d16s05_ec4db3fe:


    mc "Ouais. Ils sont super épuisants."
...
translate french d16s05_4f1f996c:
    ...
    mct "Bien sûr, je suis avec quelqu'un en ce moment."


translate french d16s05_8da67c47:


    mct "Mais je peux être là dans un moment."
...
translate french d16s05_e0a106af:
    ...
    sy "Bien. Tu sais, je veux vraiment essayer cette glace à la pâte à biscuits."
