...
translate french d16s07_ext_2b0b7b0e:
    ...
    mc "Tu m'as fait avoir une demi-crise cardiaque."
...
translate french d16s07_ext_103283d1:
    ...
    jf "Désolé. Je ne voulais pas t'effrayer. Je travaille juste mieux dans des conditions de faible luminosité."
...
translate french d16s07_ext_00fb529a:
    ...
    jf "Je ne fais même pas de travail supplémentaire autre que ce que je fais habituellement."
...
translate french d16s07_ext_e72285f8:
    ...
    mc "Eh bien, je suis content d'avoir pu aider. Tu le mérites."
...
translate french d16s07_ext_c9d92f8b:
    ...
    jf "Je connais des gens qui font un excellent travail en mettant leur âme dans leur métier mais qui en gagnent à peine leur vie."
...
translate french d16s07_ext_dbfad203:
    ...
    mc "Wow, d'accord. Tu vois grand. J'aime ça."
...
translate french d16s07_ext_e956c468:
    ...
    jf "Je veux que tu sois mon partenaire. C'est la principale chose que je voulais dire."


translate french d16s07_ext_58867373:


    mc "Je... c'est beaucoup."


translate french d16s07_ext_8419eebc:


    jf "Oh, je comprends si tu ne—"
...
translate french d16s07_ext_c52e8bf6:
    ...
    mc "Mais je ne peux pas prendre de décision de devenir partenaire en ce moment."


translate french d16s07_ext_7f8283b4:


    mc "C'est une décision importante et j'ai besoin de temps pour y réfléchir."


translate french d16s07_ext_35bad13a:


    jf "Je comprends. Je suis tout à fait d'accord avec ça."
...
translate french d16s07_ext_42077b12:
    ...
    jf "Avant, c'était juste quelque chose qui se produisait sur le moment. Demander ainsi, c'est différent."
...
translate french d16s07_ext_7cdf18a2:
    ...
    mc "*Soupir* {i}Ça{/i}, malheureusement, c'est quelque chose pour lequel je ne peux pas aider pour le moment."
...
translate french d16s07_ext_66910a6c:
    ...
    mc "Euh... Disons juste que je me suis mis dans un petit pétrin."


translate french d16s07_ext_e60a81d1:


    mc "Et mon propre cornichon est hors service jusqu'à ce que je m'en sorte."
...
translate french d16s07_ext_193fe6bc:
    ...
    jf "Euh... Non, c'est tout."


translate french d16s07_ext_fd51be2b:


    jf "Mais tu n'es pas obligé d'y aller tout de suite. On pourrait sortir un peu. J'allais demander à un de mes amis photographe de venir prendre ces photos. Je pourrais te faire un petit spectacle..."


translate french d16s07_ext_c315f7ad:


    mc "C'est une offre alléchante mais certains de mes amis m'attendent, et ils seront probablement énervés si je suis en retard."
...
translate french d16s07_ext_7b1f43ad:
    ...
    mc "Je serai sûr de le faire."


translate french d16s07_ext_969dfadf:


    mc "Je... je ne pense pas pouvoir faire ça, Jessie. Désolé."


translate french d16s07_ext_d083f9c0:


    jf "*Soupir* C'est bon. Je pensais que tu pourrais ressentir ça. C'est une demande étrange."
...
translate french d16s07_ext_2df688ed:
    ...
    jf "{i}Extrêmement{/i} bien."


translate french d16s07_ext_d388a1c1:


    jf "Quoi qu'il en soit. C'est bon. Je vais trouver une solution."


translate french d16s07_ext_ec5e4207:


    jf "Merci d'avoir accepté de m'aider avec les autres choses."


translate french d16s07_ext_576e535e:


    mc "Bien sûr. Désolé, je n'ai pas pu t'aider."


translate french d16s07_ext_81c2725d:


    jf "C'est bon. Mais tu n'es pas obligé d'y aller tout de suite. Nous pourrions sortir un peu."


translate french d16s07_ext_47716764:


    jf "J'allais demander à un de mes amis photographe de venir prendre ces photos. Je pourrais vous faire un petit spectacle..."
...
translate french d16s07_ext_451e94b8:
    ...
    mc "Je... je n'ai jamais fait quelque chose comme ça. Mais je suppose que je ne suis pas contre."
...
translate french d16s07_ext_88f96f7c:
    ...
    jf "Ce serait beaucoup plus facile si elle était ici. En plus, c'est une professionnelle."


translate french d16s07_ext_07ecb0cf:


    jf "Le client paie beaucoup d'argent pour des photos de haute qualité, et je veux livrer—"
...
translate french d16s07_ext_08ca6348:
    ...
    jf "Ouais, c'est difficile d'y rester si tu n'as pas une bonne climatisation."


translate french d16s07_ext_ac80bb3d:


    jf "Mais en même temps, le musc est ce que les clients paient."
...
translate french d16s07_ext_4084853c:
    ...
    kv "Désolé, ça a pris un peu, je devais..."
...
translate french d16s07_ext_292aaa47:
    ...
    jf "Voici Kanya. C'est la photographe dont je t'ai parlé. C'est une bonne amie à moi."


translate french d16s07_ext_3b7535cc:


    mc "Bonjour, ravi de vous rencontrer."


translate french d16s07_ext_506e887d:


    mct "Je suppose que ce n'est pas si grave."


translate french d16s07_ext_d5920b6e:


    kv "C'est réciproque. J'ai entendu parler de toi."
...
translate french d16s07_ext_14f8898a:
    ...
    mc "Prêt comme je le serai toujours."
...
translate french d16s07_ext_bd288db5:
    ...
    jf "Ouais, le client voulait que nous soyons par terre... pour une raison quelconque."


translate french d16s07_ext_51048004:


    jf "J'ai mis un peu de rembourrage, donc j'espère que ce n'est pas trop douloureux."
...
translate french d16s07_ext_4f1947be:
    ...
    jf "Le client n'a pas vraiment précisé."


translate french d16s07_ext_965570c9:


    kv "Je pense que ce serait cool si nous avions des photos artistiques avec un soupçon d'histoire."


translate french d16s07_ext_ae302035:


    kv "Peut-être que c'était juste Jessie au début, en train de brouter dans la savane, quand tout d'un coup [mcname] s'approche d'elle."
...
translate french d16s07_ext_23b58a28:
    ...
    mct "Elle est vraiment enthousiaste."
...
translate french d16s07_ext_0b1674ec:
    ...
    jf "[mcname], s'il te plaît, je veux que tu me manges."
...
translate french d16s07_ext_ad04bba8:
    ...
    mct "Wow, c'est une vraie réalisatrice de porno."


translate french d16s07_ext_7cadd660:


    jf "*Gémis* Oh, mon Dieu... Juste là."


translate french d16s07_ext_3b7fdde5:


    kv "C'est magnifique. Prends cette pose pour moi."
...
translate french d16s07_ext_e944dc8f:
    ...
    jf "C'était incroyable..."


translate french d16s07_ext_76d372e3:


    kv "Ça l'était. C'était génial."


translate french d16s07_ext_2e2eaf2c:


    kv "Maintenant qu'elle est prête, prends-la [mcname]. Approprie-la et mets-lui un bébé."
...
translate french d16s07_ext_2dcd21b1:
    ...
    jf "*Gémit fort* Mmm... C'est si bon. Plus fort, baise-moi plus fort."
...
translate french d16s07_ext_f96c02be:
    ...
    kv "Baise-moi, c'était phénoménal. Vous êtes géniaux tous les deux."


translate french d16s07_ext_2488a094:


    kv "J'aurais aimé que [mcname] entre. Cela aurait été la cerise sur le gâteau."


translate french d16s07_ext_3bcee771:


    mct "Je suppose qu'elle était aussi très excitée par tout cela."


translate french d16s07_ext_a955bbf8:


    kv "Nous avons obtenu de superbes photos. Je pense que le client les appréciera vraiment."


translate french d16s07_ext_09af46de:


    jf "Fais aussi quelques gros plans de moi."
...
translate french d16s07_ext_bdeb7b06:
    ...
    jf "Si [mcname] est d'accord."


translate french d16s07_ext_09f996e0:


    mc "Oh, je suis toujours déprimé. Peut-être que Kanya peut aussi s'habiller."
...
translate french d16s07_ext_16093107:
    ...
    kv "Très bien. {i}Peut-être{/i}"


translate french d16s07_ext_81095674:


    mct "J'ai obtenu [d16s07_points] points. Pas mal."
