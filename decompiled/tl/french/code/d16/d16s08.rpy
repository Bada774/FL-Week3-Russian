...
translate french d16s08_96b21177:
    ...
    mc "Non. Elle ne s'attend pas à ce que je l'appelle avant ce soir."
...
translate french d16s08_219a3ecf:
    ...
    arj "Pendant que Stacy y travaille, je voulais te parler de tes projets pour cette semaine."
...
translate french d16s08_792e2594:
    ...
    arj "Ouais, nous devons tous les deux étudier, mais je parlais de tes autres projets."


translate french d16s08_29e0e3f7:


    mc "En dehors de cela, j'ai juste besoin d'accumuler autant de points que possible dans l'application."


translate french d16s08_97ccb2a7:


    arj "Exactement. Réfléchissons."


translate french d16s08_881c0930:


    mc "Je pensais que ça arriverait naturellement. Je n'avais pas vraiment besoin de planifier la semaine dernière-"


translate french d16s08_1a299b8b:


    arj "Et tu as perdu ce défi. Nous aurions dû mieux planifier."
...
translate french d16s08_594a9b43:
    ...
    arj "Eh bien, deux d'entre nous sont évidents."
...
translate french d16s08_a49e7683:
    ...
    mc "Ce ne sera pas difficile. Nous avons déjà baisé la semaine dernière."
...
translate french d16s08_a89d2d90:
    ...
    mc "Apparemment, elle est douée pour les pipes, donc je vais probablement la poursuivre dans cette direction."


translate french d16s08_08bd4667:


    arj "Je ne te demanderai pas comment tu sais ça."
...
translate french d16s08_442aaef4:
    ...
    arj "Je ne demanderai pas."


translate french d16s08_d2c66ab1:


    mc "Et puis il y a la sœur de Hana, Iona."


translate french d16s08_10d18e6f:


    mc "Et puis il y a la petite amie de Hana, Iona."


translate french d16s08_94638573:


    arj "Oh ouais, la barman. Elle fait aussi partie du programme VIP."


translate french d16s08_003a5edd:


    arj "Oh ouais, la barman. Elle est aussi en rétention."


translate french d16s08_cd84f12c:


    mc "C'est probablement ainsi qu'Hana a découvert Fetish Locator et le programme VIP."


translate french d16s08_2d5b8083:


    mc "C'est probablement ainsi qu'Hana a découvert Fetish Locator et le programme de rétention."
...
translate french d16s08_3a994f92:
    ...
    arj "Oh, c'est vrai. Elle était sur ta liste la semaine dernière."
...
translate french d16s08_3fe466db:
    ...
    mc "À ce stade, leurs rendez-vous à l'aveugle sont terminés, mais j'ai le sentiment qu'ils veulent toujours que je sois impliqué dans leur relation."


translate french d16s08_56b51bcb:


    arj "Je n'arrive toujours pas à croire que tu as couché avec les deux.{w}.. et surtout je n'arrive pas à croire que tu as couché avec les deux ensemble."
...
translate french d16s08_0e75454c:
    ...
    mc "Daisy et moi sommes devenus très proches, mais... je ne sais pas."
...
translate french d16s08_455a3c97:
    ...
    mc "Non, certainement pas. {w}Elle a un problème de santé..."
...
translate french d16s08_348af411:
    ...
    mc "J'ai peur que la prochaine fois qu'elle soit trop excitée... ce ne soit pas bon pour elle."


translate french d16s08_cf7d1e52:


    arj "Je suppose que c'est son choix. {w}Parle-lui-en."
...
translate french d16s08_92664674:
    ...
    arj "Je peux comprendre ça."


translate french d16s08_ceec81e5:


    mc "Dahlia et moi sommes devenus très proches."
...
translate french d16s08_d3c78865:
    ...
    mc "Elle a un extérieur épineux, mais un cœur chaleureux."
...
translate french d16s08_cfa86b8c:
    ...
    mc "Elle essaie d'être une meilleure dominatrice. Je ne pense pas que ce sera à nouveau un problème."


translate french d16s08_a536397a:


    arj "Si elle te fait du mal, je la tuerai."
...
translate french d16s08_f2c0c8a6:
    ...
    mc "Lyssa est définitivement une option. Je n'aime pas la mettre dans le collimateur de Fetish Locator, mais nous sommes intimes."
...
translate french d16s08_a7ee4e45:
    ...
    arj "Fetish Locator devrait avoir plus peur d'elle que de l'application."
...
translate french d16s08_6e10e723:
    ...
    mc "Il est mignon. Je peux l'aider. Et il est très doué pour...{w} certaines choses."


translate french d16s08_9aa1a868:


    arj "Je suppose que personne ne sait mieux comment faire plaisir à un homme qu'un autre homme."


translate french d16s08_4a5dd297:


    mc "Je ne dirais pas ça. {w}C'est plutôt une expérience homosexuelle pour moi."


translate french d16s08_944a1ab2:


    arj "Eh bien, nous sommes à l'université."


translate french d16s08_27854666:


    arj "Bien sûr, tu dois consacrer du temps à Stacy."


translate french d16s08_dff89196:


    mc "Je ne veux pas qu'elle soit impliquée dans tout ça. Fetish Locator ne devrait pas-"


translate french d16s08_b4d35f8f:


    arj "L'application sait déjà que vous avez baisé tous les deux."
...
translate french d16s08_acaa851b:
    ...
    arj "C'est très gentil que tu veuilles assurer sa sécurité, mais elle s'est impliquée dans ça."


translate french d16s08_bc76392d:


    mc "Très bien. Stacy peut être sur la liste."


translate french d16s08_64be4049:


    sy "Mes oreilles me brûlent."
...
translate french d16s08_cad3726a:
    ...
    arj "Je suppose que ce n'est pas vraiment surprenant."


translate french d16s08_94d43672:


    mc "Je ne suis pas sûr de ce que je ressens à ce sujet. {w}Ça pourrait être vraiment excitant ou cela pourrait être tout simplement bizarre."


translate french d16s08_3b9f88e3:


    arj "Embrasse ton bizarre."


translate french d16s08_9ca95409:


    mc "C'est ça le problème. Je ne sais pas si c'est bizarre ou si je serais simplement d'accord."


translate french d16s08_dae549fb:


    arj "De toute façon, elle est chaude et baisable."
...
translate french d16s08_11b0942a:
    ...
    mc "Des dizaines, mais la prochaine qui mérite d'être mentionnée ici est Vanessa."
...
translate french d16s08_d5f65023:
    ...
    arj "Oh cool. Il n'y en a pas assez."


translate french d16s08_2d2c4d9e:


    mc "D'accord. Nous devrions faire une demande avec l'application ou quelque chose comme ça. Faites-lui savoir nos pervers et fétiches préférés."


translate french d16s08_7569df1e:


    arj "Non. Ils en savent déjà trop sur nous."


translate french d16s08_a423f556:


    arj "Je suppose qu'il y a juste une autre chose que nous devrions essayer de comprendre."
...
translate french d16s08_16eb46b0:
    ...
    mct "Putain. Je suis censé rencontrer Nora bientôt."


translate french d16s08_05d61a93:


    mct "Eh bien, merde. Je n'ai pas encore décidé si je vais avec elle ou non."


translate french d16s08_006e9486:


    mct "Si j'y vais, alors je pars avec elle. Pour de bon."


translate french d16s08_f3442d50:


    mct "Si je n'y vais pas, alors elle partira probablement sans moi..."


translate french d16s08_b45b3cee:


    mct "Elle restera en contact et je serai toujours un homme debout et un père pour notre enfant, mais..."
...
translate french d16s08_84d80062:
    ...
    mc "Je te retrouve là-bas. J'ai autre chose à régler."


translate french d16s08_1315783c:


    arj "Oh... d'accord. {w}Ne me fais pas attendre trop longtemps."


translate french d16s08_7ef6443c:


    mct "Je vais juste faire une petite promenade et réfléchir à tout ça."


translate french d16s08_27bf13da:


    mct "Ensuite, je déciderai si je pars avec Nora ou non."


translate french d16s08_bc6983b9:


    mc "Pas encore, mais j'espère que quand nous arriverons chez toi."
