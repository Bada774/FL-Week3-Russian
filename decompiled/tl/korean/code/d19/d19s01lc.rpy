...
translate korean d19s01lc_22633b42:
    ...
    mc "아.{w} 어, 나한테 무슨 일이 있었던 거야?"


translate korean d19s01lc_14ec0b13:


    lc "비공식적으론, 넌 경찰 술집에서 술에 취해선 비번인 경관한테 주먹을 날렸어."
...
translate korean d19s01lc_e9bba1fe:
    ...
    lc "공식적으론, 넌 여기에 온 적도 없고, 거기에 간 적도 없고, 거긴 다시 가지도 않을 거야."
...
translate korean d19s01lc_ad9c99fc:
    ...
    lc "날린 주먹은 완전 빗나갔어, 그래도 안부를 물어보다니 참 착하네."
...
translate korean d19s01lc_047f72c2:
    ...
    lc "응, 네가 일어났다고 내가 전하기만 하면 바로 나갈 수 있을 거야."
...
translate korean d19s01lc_26b5e011:
    ...
    mc "음, 그런데 왜 지금 말하러 가지 않는 거야?"


translate korean d19s01lc_350d3aa5:


    lc "*한숨* 우리 서로 이야기할 게 있으니까.{w} 그러고 나서 자리를 바꾸자."
...
translate korean d19s01lc_ffdafa71:
    ...
    lc "아직 숙취 때문에 잘 기억이 나지 않을 수도 있겠지만..."


translate korean d19s01lc_72aa34fa:


    lc "어젯밤에 숫집에서 고주망태가 된 이유가 기억나?"
...
translate korean d19s01lc_9c20bd51:
    ...
    lc "맞아, 내가 그랬어.{w} 전부 내가 한 짓이었지.{w} 계속 나였어."


translate korean d19s01lc_c4a90e49:


    mc "이해가 안 돼.{w} 어떻게 그럴 수가-"


translate korean d19s01lc_82448b92:


    lc "그냥 재미있는 일이라고 생각했어."


translate korean d19s01lc_6a07d043:


    mc "페티시 로케이터가?{w} 그 VIP 계획도!{w} 네가 처음부터 날 조종했던 거지?!"


translate korean d19s01lc_93456400:


    mc "페티시 로케이터가?{w} 그 유지 계획도!{w} 날 협박하는 게 너한텐 그냥 재미있는 일이었어?!"


translate korean d19s01lc_fdf38331:


    lc "아냐!{w} 그 일에 관해선 어제까진 아무것도 몰랐어!"
...
translate korean d19s01lc_b8434a6f:
    ...
    lc "페티시 로케이터는 내 생각 맞아. 내 꿈이었다고!"


translate korean d19s01lc_1d50fecb:


    lc "난 페티시 로케이터에서 VIP 계획이 시작된 것도 백만 달러 상금이 걸린 것도 몰랐어!!! 난 재미있고 섹시한 일을 하는 앱이라고만 알고 있었단 말이야!"


translate korean d19s01lc_60e0f87b:


    lc "난 페티시 로케이터가 사람들이 협박하고 있는 줄 몰랐어!!! 난 재미있고 섹시한 일을 하는 앱이라고만 알고 있었단 말이야!"


translate korean d19s01lc_97b659b1:


    mc "잠깐만.{w} 나 아직 술이 좀 덜 깼어. 그리고 술 때문에 머리도 아파. 엄청 화도 났고."


translate korean d19s01lc_fa2d7d01:


    mc "아침 같은 거라도 먹은 다음에 이야기하면 안 될까?"


translate korean d19s01lc_bc374c4c:


    lc "안 돼.{w} 지금이 아니면 넌 내 말을 안 들을 테니까."


translate korean d19s01lc_b397ca00:


    mc "그래서, 지금 너 말 그대로 날 감금해 두겠다는-"


translate korean d19s01lc_18631ab5:


    lc "미안해.{w} 그치만 너한텐 꼭 말해야 돼. 더는 기다려 달라고 할 수도 그냥 가게 둘 수도 없어."


translate korean d19s01lc_8b17e1a1:


    mc "*한숨* 끝내주네. 내 생각엔 우리 사이에 신뢰라는 게 더는 안 남아 있는 거 같은데."
...
translate korean d19s01lc_88d35882:
    ...
    mc "됐어. 그냥 말해.{w} 어차피 난 네 포로나 다름없는 처진걸."


translate korean d19s01lc_9ba9155c:


    lc "*한숨* 페티시 로케이터는 내 꿈이었어."


translate korean d19s01lc_a7311bf4:


    lc "이미 알고 있겠지만, 나한텐 성적 교제를 할 수 없는 문제가 있어. 하지만 성적 욕망은 있었지. 그래서 페티시 로케이터는 성적 교제를 걱정하지 않고 내 성적 욕망을 해결할 수 있는 수단이었어."


translate korean d19s01lc_58100dc9:


    lc "사람들이 하고 싶어 하는 섹스 앱을 만들면, 사람들이 이 앱으로 내가 가늠할 수 없을 정도로 엄청난 양의..."


translate korean d19s01lc_2ee679f1:


    mc "아마추어 포르노를 만들어서 너한테 딸감을 제공해 줄 거라고?"


translate korean d19s01lc_ff0e2253:


    lc "대리 체험을 제공해 줄 거라고 생각했어."


translate korean d19s01lc_a99c56fc:


    lc "직접 그런 일을 할 필요 없이, 보고 배우고 체험할 수 있게 된 거야."


translate korean d19s01lc_e3d87039:


    lc "바보 같은 이야기라는 건 알아, 하지만 이 일로 다치는 사람은 없을 거라고 생각했지."


translate korean d19s01lc_dce2dd8b:


    lc "누가 페티시 로케이터 때문에 피해를 볼 거라곤 생각해 본 적도 없어. 제롬은 모든 게 암호화되고 철처하게 보관되서 100%% 안전하다고 했으니까."


translate korean d19s01lc_57c72c9c:


    mc "제롬?!{w} 그 등신이랑 이게 무슨 상관인데?"


translate korean d19s01lc_ffd73934:


    lc "난 기술에 관해선 잘 모르니까. 인터넷에 영상도 간신히 올리는걸. 그래서 사이트를 만들어 줄 전문가가 필요했어."


translate korean d19s01lc_fb7e8aec:


    lc "난 제롬이 믿을 만한 사람이라고 생각했고."


translate korean d19s01lc_afd98814:


    mc "그래서, 제롬이 모든 일의 배후란 거야?{w} 그 자식 박살내고 말겠어."


translate korean d19s01lc_cc0b9a5b:


    mc "그래서, 사람들을 협박한 장본인이 제롬이라는 거야?{w} 그 자식 박살내고 말겠어."
...
translate korean d19s01lc_de24ff1e:
    ...
    lc "리들리. 리들리 스콧처럼.{w} 제롬은 에이리언을 엄청 좋아했어. 그래서 인공 지능에 리플리라는 이름을 붙여 주고 싶어했지만, 이 인공 지능은 남자여야 한다면서-"


translate korean d19s01lc_169e4149:


    mc "그 자식이 인공 지능을 만들었다고.?{w} 그게 가능이나 해?"


translate korean d19s01lc_2bd4891e:


    lc "제롬은 인공 지능이라고 했어. 인간 같은 일은 못해도, 앱은 운용할 수 있었지."


translate korean d19s01lc_0c3f0006:


    mc "나...{w} 나 정말 헷갈리고 화도 나서 정말 내가 어떻게 하면 좋을지 모르겠는데."
...
translate korean d19s01lc_91ccba53:
    ...
    mc "정말 어처구니가 없네! 지금 나한테 페티시 로케이터가 무슨 섹스랑 야동으로 가득 찬 할 9000이라는 소리야!!!"


translate korean d19s01lc_60444f69:


    lc "음, 그런 셈이지.{w} 제롬이 사라지지 않았다면 쉽게 고칠 수 있었겠지."


translate korean d19s01lc_3defe89c:


    mc "그 십새끼 어디 있어?! 죽여 버리겠어!{w} 그다음에 지옥에서 그 병신을 끌어낸 다음에 개좆 같은 리들리를 고치게 하겠다고."


translate korean d19s01lc_002a889a:


    lc "나도 모르겠어.{w} 거의 일주일 동안 걜 본 사람이 없는걸."


translate korean d19s01lc_3ab36586:


    mc "개소리! 민네 파티에서 바텐더 괴롭히는 걸 봤구만!"


translate korean d19s01lc_c0cb4cc7:


    lc "벌써 일주일 지났잖아.{w} 그 이후로 본 사람이 없어."


translate korean d19s01lc_5642385e:


    mct "그 일이 있은 다음에 민이 농담식으로 그 자식 죽여 버리겠다는 말을 하긴 했는데."
...
translate korean d19s01lc_1ef5a556:
    ...
    lc "내 사랑, [mcname], 제발. 진정하고 제발 내 말 좀 들어 줘."
...
translate korean d19s01lc_43ce2e2d:
    ...
    lc "난 네가 필요하니까.{w}.. 네가 내 말을 들어 줬으면 하니까."


translate korean d19s01lc_630ea5ff:


    mc "좋아. 그래서, 이게 네 꿈이었다는 거네."


translate korean d19s01lc_cfa80054:


    mc "제롬은 에이리언에 나오는 비숍 같은 걸 만들었고 그게 맛이 갔다는..."


translate korean d19s01lc_306f6ad6:


    mc "제롬은 에이리어네 나오는 비숍 같은 걸 만들었고 그게 사람들을 협박하기 시작했다는..."


translate korean d19s01lc_841182aa:


    lc "날 위해서 섹시한 콘텐츠를 확보하도록 프로그래밍되어 있을 뿐이라고 생각해. 그런데 너무 과해진 거지."


translate korean d19s01lc_5643898f:


    mc "이러나저러나 제롬 그 새끼는 개자식이야.{w} 그 자식이 VIP 계획을 만들어서 자길 거부한 너한테 앙갚음을 하고 있는 거겠지."


translate korean d19s01lc_2615dea8:


    mc "이러나저러나 제롬 그 새끼는 개자식이야.{w} 사람들을 협박하는 것도 그 자식 계획이었겠지."
...
translate korean d19s01lc_d68d42d5:
    ...
    lc "[mcname], 날 용서해 수 있겠니?"


translate korean d19s01lc_1196ae30:


    mc "아마도.{w} 네가 이 구류장에서 날 빼내 주면."


translate korean d19s01lc_a27a6d78:


    lc "알겠어.{w} 음, 나한테도 아직 널 위해서 해 줄 수 있는 일이 남아있었네."
...
translate korean d19s01lc_aa940d40:
    ...
    lc "사람들을 속였으니까, 결국 나한테 책임이 있어."


translate korean d19s01lc_fee94fbe:


    lc "사람들이 다쳤어. 협박을 받았지. 내 책임이야."


translate korean d19s01lc_66b4e40c:


    mc "윤리적으론 그렇지. 하지만 법적으론 전부 제롬이 한 일이잖아."
...
translate korean d19s01lc_1c1da538:
    ...
    mc "페티시 로케이터는 재미있었어.{w} 그런 일이 있기 전엔... 굳이 말은 안해도 알겠지."


translate korean d19s01lc_a7bed98d:


    mc "페티시 로케이터는 재미있었어.{w} 협박을 받기 전에는."
