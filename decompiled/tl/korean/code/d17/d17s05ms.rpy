...
translate korean d17s05ms_f36ffea4:
    ...
    mc "퍽이나. 허리는 앞으로 굽었고 얼굴은 걱정으로 가득찼으니, 완전히 선승이 따로 없으시구랴."
...
translate korean d17s05ms_00c805b8:
    ...
    sy "나쁜 생각이었던 거 같아서. 나랑은 거의 아는 사이도 아니잖아."
...
translate korean d17s05ms_b3669d60:
    ...
    sy "그런데도 이렇게 무턱대고 와 버렸어, 정말..."


translate korean d17s05ms_cdb6db60:


    mc "리사가 널 싫어할까 봐 걱정된다고?"
...
translate korean d17s05ms_da82bbda:
    ...
    mc "리사는 네가 고등학교에서 홀딱 반했던 애처럼 굴지 않을 거라구."


translate korean d17s05ms_19a2f426:


    sy "난 리사한테 홀딱 반한 거 아냐!"


translate korean d17s05ms_b6dd4bf4:


    mc "스테이시 말이 되는 소리를 해라. {i}딱 봐도{/i} 네가 리사한테 꽂힌 거 알겠구만."
...
translate korean d17s05ms_0413c3df:
    ...
    mc "있잖냐. 처음엔 네가 언제나처럼 참견이나 하려고 같이 가려나 보다고 했는데, 네 반응을 보니까 머리에 전깃불이 들어오면서 다 이해가 되더라."
...
translate korean d17s05ms_9a52e4d1:
    ...
    sy "난 리사가 그냥 멋진 사람이라고만 생각했는데, 지금은 내 마음이 어떤지 모르겠어."


translate korean d17s05ms_79f050ff:


    mc "음, 나도 리사가 멋지다고 생각해. 내 생각엔 리사도 널 멋지다고 생각할 거야."


translate korean d17s05ms_f4eb7489:


    mc "이제 척추 옆굽음증 걸리기 전에 똑바로 서. 여기서 내려야 하니까."


translate korean d17s05ms_457dc575:


    sy "으윽, 지가 무슨 아빠가 된 거처럼 굴고 있어."


translate korean d17s05ms_50964085:


    sy "*휘파람* 젠장. 부자라는 건 알았지만, 이건 정말 {i}훌륭한데{/i}."
...
translate korean d17s05ms_db00d39d:
    ...
    mh "모두 어서와요. 기다리고 있었어요."


translate korean d17s05ms_b1b0620a:


    mh "스테이시 양, 맞죠? 오랜만에 뵙네요."


translate korean d17s05ms_0e0f46ef:


    sy "안녕하세요, 그렇죠. 저번에 리사 씨랑 [mcname] 녀석이 데이트하던 거 망쳤을 때 보고 처음 뵙네요."


translate korean d17s05ms_e8988ac5:


    mh "아, 그때 일은 신경 안 쓰셔도 돼요."
...
translate korean d17s05ms_8e58feee:
    ...
    mh "고마워요. 법정 그리고 의뢰인과의 잡담을 견딘 다음엔, 집에 와서 즐기는 고요가 정말 좋더라구요."
...
translate korean d17s05ms_04102043:
    ...
    mc "낮부터 퍼마실 정도로 지금 내 인생이 좆되진 않았으니까. 술 마시는 건 사양할게."


translate korean d17s05ms_60fc136c:


    sy "나중엔 그 정도로 좆되면 좋겠냐?"


translate korean d17s05ms_c1d497d2:


    mh "*웃음* 차? 커피? 아니면 신선한 주스라도?"
...
translate korean d17s05ms_893545f5:
    ...
    mh "훌륭해요. [mcname], 당신은 정말 아무것도 안 마시려고?"
...
translate korean d17s05ms_2ec91354:
    ...
    mc "리사! 게임 어디에 있어? 차 끓이는 동안 내가 준비해 놓을게."
...
translate korean d17s05ms_63332afb:
    ...
    mh "비인도적인 카드를 하는 건 어때? 우리가 어디까지 가는지 해 보자."
...
translate korean d17s05ms_30df9cf2:
    ...
    mh "자, 이 게임은 가장 최근에 어... \"응아\"를 본 사람부터 시작해."


translate korean d17s05ms_947f8759:


    mc "... 참 흥미로운 방법으로 시작할 사람을 뽑는걸."


translate korean d17s05ms_448cce68:


    mc "으흠, 그러면 내가 가장 최근에 똥 싼 사람 같은데?"
...
translate korean d17s05ms_cbf39a11:
    ...
    mc "이거 재미있겠는데. 이제 둘이 가장 극악무도한 하얀 카드를 뽑아야 하는 거지?"
...
translate korean d17s05ms_6ad7a9cd:
    ...
    mh "이제 하얀 카드를 섞고 가장 재미있는 걸 하나 뽑아."
...
translate korean d17s05ms_e95e1241:
    ...
    mc "나는 게임에서 하라고 하는대로 했을 뿐이라구!"


translate korean d17s05ms_0967333f:


    sy "그 정도가 아냐, 형씨, 그건 완전 엿 같다구."
...
translate korean d17s05ms_f2768387:
    ...
    mc "내가 가져올게. 둘은 터놓고 이야기라도 하고 있으라고."
...
translate korean d17s05ms_30592f4d:
    ...
    mh "천만에요. 스테이시 양이 와 주니 정말 기쁜걸요."


translate korean d17s05ms_4e098d40:


    mh "대학생이라고 하셨던가요? 아니 [mcname]한테 그런 말을 들었던가."


translate korean d17s05ms_33f0e9f8:


    sy "아뇨, 사실 대학생은 아니에요. 입학은 내년에 해요. 지금은 그냥 놀면서, 제 자유를 즐기고 있는 거죠."


translate korean d17s05ms_1f279512:


    sy "단기간 일자리에 지원을 {i}하고 있어요{/i}. 돈이나 받으면서 살 순 없으니까요. 대부분은 반응도 없지만요."
...
translate korean d17s05ms_52178f1a:
    ...
    sy "네, 전단을 봤거든요. 어차피 인생 한 번뿐인데 그냥 지원이나 해 보자 했는데 됐지 뭐예요."


translate korean d17s05ms_925db1c1:


    mh "실은 제가 경찰 쪽에 아는 사람들이 있어요."


translate korean d17s05ms_e5daed2f:


    sy "정말요? 와아, 정말 인맥이 좋네요."


translate korean d17s05ms_4bdfe8ba:


    mh "직업 특성상 인맥이 있으면 도움이 되니까요. 물론 어떤 직업이나 인맥은 도움이 되지만요."
...
translate korean d17s05ms_7fe5f872:
    ...
    sy "전, 음, 경찰에서 저한테 준 일은 기본적으로 디지털 청소부 같은 거예요."


translate korean d17s05ms_d8309af7:


    sy "실은 전 소프트웨어 개발 쪽 일을 찾고 있었지만요."


translate korean d17s05ms_8e166129:


    mh "그럼 그쪽으로 지원이 가능한지 제가 알아봐 주길 원했던 거로군요?"
...
translate korean d17s05ms_72ecdcaa:
    ...
    mh "장담할 순 없지만, 분명히 제가 할 수 있는 일이 있을 거예요."


translate korean d17s05ms_b44fc933:


    mc "이런, 높은 곳에 친구가 있으니 정말 도움이 되는걸, 그치?"


translate korean d17s05ms_380f3a59:


    sy "감사합니다. 저한텐 큰 의미가 있어요."
...
translate korean d17s05ms_1df8c053:
    ...
    sy "\"촛불을 켠 낭만적인 저녁 식사 자리가 완벽해지려면...\""


translate korean d17s05ms_38f2922e:


    sy "혹자가 말하길, \"촛불을 켠 낭만적인 저녁 식사 자리가 완벽해지려면... 방귀 끼고 나가 버려야 한다.\""
...
translate korean d17s05ms_19c94722:
    ...
    sy "그리고 또 다른 이가 말하길, 촛불은 켠 낭만적인 저녁 식사 자리가 완벽해지려면... *낄낄거리며* 자기 여동생이랑 떡을 쳐야 한다."


translate korean d17s05ms_c2182fbf:


    sy "그리고 또 다른 이가 말하길, 촛불을 켠 낭만적인 저녁 식사 자리가 완벽해지려면... *낄낄거리며* 자기 절친이랑 떡을 쳐야 한다."
...
translate korean d17s05ms_b2c78739:
    ...
    sy "넌 날 촛불 켠 저녁 식사 자리엔 데리고 가지도 않았으면서— 으흠."
...
translate korean d17s05ms_a76affa3:
    ...
    mh "난 둘이 정말 그 정도로 밀접한 사이인지 믿을 수가 없는걸."
...
translate korean d17s05ms_af460b14:
    ...
    mh "둘이 정말 그런 사이라니 믿기지가 않네."


translate korean d17s05ms_83c4a9da:


    mh "둘이 그저 사이좋은 오누이라고만 생각했는데, 이런."


translate korean d17s05ms_bb0ecec3:


    mh "둘이 그저 사이좋은 친구라고만 생각했는데, 이런."
...
translate korean d17s05ms_8f40946f:
    ...
    mh "아, 당신 스테이시 양한테 아무런 말도 안 했던 거야?"
...
translate korean d17s05ms_992cdfb0:
    ...
    mh "오, 이런 가엽기도 하지. 이리 오렴."


translate korean d17s05ms_4bf59fb6:


    mh "당신 오빠랑 난 일종의... 열린 관계를 맺고 있어."


translate korean d17s05ms_e562842a:


    mh "당신 친구랑 난 일종의... 열린 관계를 맺고 있어."


translate korean d17s05ms_4aaa8287:


    mh "난 당신과 저이 사이가 어떤 관계이든 괜찮아. 도리어 귀여울 정도인걸."


translate korean d17s05ms_19b9503b:


    mh "그리고 그 어, 둘 사이의 {i}특수성{/i}도, 난 개의치 않아."


translate korean d17s05ms_187dd654:


    mh "감정은 제각기 다른 형상과 질료로 나타나니까. 그리고 난 사상경찰 같은 게 아닌걸."


translate korean d17s05ms_ac8382a6:


    mh "그 관계에서 두 사람이 서로 좋아한다면, 모든 사랑스럽고 동의에 기반을 둔 관계와 마찬가지로 정당하다고 생각해."


translate korean d17s05ms_cba91f7c:


    mh "그러니 당신은 내가 알까 봐 걱정하지 않아도 돼. 알겠지?"
...
translate korean d17s05ms_9c277668:
    ...
    mc "야, 난 그냥 \"사회\"만 조심하라고 했다."


translate korean d17s05ms_431ebb30:


    sy "이 자식은 나한텐 철면피처럼 다른 사람 앞에서 조심해야 한다고 했으면서. 리사한텐 쪼르르 달려 가서는 다 말해 버렸잖아."


translate korean d17s05ms_823497f6:


    mh "난 그래서 저이가 마음에 드는걸. 솔직하니까."


translate korean d17s05ms_7dff4cbe:


    mc "그게 바로 나지, 솔직한 [mcname]."
...
translate korean d17s05ms_e98a59f9:
    ...
    sy "제길, [mcname] 자식이 이 정도로 야비한 자식인 줄 몰랐어."


translate korean d17s05ms_559239f0:


    mc "재량껏 모든 전술을 사용한 사람한테 야비한 자식이라고 하면 안 되지롱."
...
translate korean d17s05ms_fecbc7ea:
    ...
    mh "이이가 야비하긴 하지만, 그래도 귀엽게 야비하잖아."


translate korean d17s05ms_625d32ad:


    sy "동의. 그래도 야비한 자식은 야비한 자식이야."
...
translate korean d17s05ms_cb1d990a:
    ...
    mc "*낄낄* 이래서야 밤샘 파티는 절대 못하겠네."


translate korean d17s05ms_60dd5920:


    mc "이제 꽤 {i}늦었으니까{/i}, 우린 가야지."
...
translate korean d17s05ms_2ab92e05:
    ...
    mc "아까는 불안해서 무슨 폐인처럼 굴더니, 이젠 완전히 변했네."
...
translate korean d17s05ms_30de715b:
    ...
    mh "귀여운 동생을 그렇게 놀리면 안 되지, [mcname]."


translate korean d17s05ms_59aa8867:


    mc "친구를 그렇고 놀리면 안 되지, [mcname]."


translate korean d17s05ms_4cc34481:


    mc "왜 한 소리 듣는 건 항상 나야?"


translate korean d17s05ms_afe118df:


    sy "그야 네가 한소리 {i}{b}듣을{/b}{/i} 짓을 많이 하니까 그렇지."
...
translate korean d17s05ms_8a8091e3:
    ...
    mh "즐거웠다니 나도 기뻐. 오늘 두 사람이랑 오붓한 시간 보낼 수 있어서 정말 좋았어."
...
translate korean d17s05ms_6cdab6d8:
    ...
    mc "좋아, 잉꼬 여러분, 수다 떨 시간은 나중에도 많아요."


translate korean d17s05ms_3f65b53c:


    mh "이이 말이 맞아. 곧 다시 만날 수 있는걸."
