...
translate korean d17s05_e56699f9:
    ...
    mh "좋아. 나 오늘은 집에 있어. 당신이 들러 줄 수 있는지 궁금해서."


translate korean d17s05_e3619dc6:


    mc "들를 수 있냐구? 으으음, 우리 같이 뭘 {i}할 건데{/i}?"


translate korean d17s05_2818dd51:


    mh "우리가 할 일이 없어서 곤란한 적은 한 번도 없었으니까. 이번에도 걱정 안 해도 될 거야."


translate korean d17s05_9769b0ab:


    mh "게다가, 만약의 경우엔 같이할 만한 {i}보드 게임{/i}도 많이 준비해 뒀어."
...
translate korean d17s05_665f6e6f:
    ...
    mh "다른 사람 데리고 와도 돼. {i}보드 게임{/i}은 같이할 사람이 많을 수록 더 재미있잖아? 어느쪽이든 난 좋아."


translate korean d17s05_650388e7:


    mct "누구를 불러야 할까?" nointeract
...
translate korean d17s05_9ec605f7:
    ...
    mh "올리버? 올리버가 점점 당신 마음에 드나 봐?"


translate korean d17s05_efb8b782:


    mc "글쎄, 뭐라고 할까. 올리버는 귀엽잖아."
...
translate korean d17s05_01dd70b3:
    ...
    mh "스테이시 양?{w} 물론 괜찮지. 나도 스테이시 양이랑 이야기하고 싶었어."
...
translate korean d17s05_2b401961:
    ...
    mc "누굴 데리고 갈 수도 있겠지만, 나 혼자 널 독차지 하고 싶은데."
...
translate korean d17s05_3ace6ad6:
    ...
    mc "리사가 자기 집에 날 초대했어. 같이 놀고, 시간도 보내고, 그런 걸 하려고."
...
translate korean d17s05_a003905d:
    ...
    mc "글쎄, 리사가 누굴 데리고 와도 된다고 했거든. 그래서 너라면 괜찮지 않을까 했는데?"


translate korean d17s05_beebcd8c:


    mc "싫으면 같이 안 가도 돼. 그냥 우리 모두 서로에 관해서 알 수 있는 좋은 기회라고 생각했을 뿐이니까."


translate korean d17s05_4be1fc12:


    op "...갑작스럽긴 하지만, 괜찮을 거 같아요."
...
translate korean d17s05_113cd47c:
    ...
    sy "친히 전화를 다 하셨으니, 큰 일이라도 일어난 거 아니냐고."


translate korean d17s05_24319d89:


    mc "그래서 전화 받자 마자 든 생각이 누가 {i}죽었다{/i}라는 거야?"


translate korean d17s05_d62c9a92:


    sy "나한테 뭐라고 할 일이냐, 형씨. 왠만한 일이면 문자만 찍찍 하는 양반이 갑자기 전화를 다 하셨으니 내가 그럴 만도 하지 않냐고."


translate korean d17s05_beaa3d79:


    mc "나 참— 이럴 때냐? 네 바보짓에 어울리는 건 사양이야."
...
translate korean d17s05_300d8de6:
    ...
    mc "아무렴 어떠냐. 준비해, 내가 데리러—"


translate korean d17s05_def5f643:


    mct "망할 내 말이 끝나기도 전에 끝어 버렸네."
