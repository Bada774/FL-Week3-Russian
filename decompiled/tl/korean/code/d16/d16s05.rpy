...
translate korean d16s05_95fb65d7:
    ...
    sy "아, 제발. 내 알몸 본 적 없는 척하냐."


translate korean d16s05_c1f733bb:


    sy "그건 그렇고, 사생활 존중할 생각이 있으면 문을 두드렸어야지."
...
translate korean d16s05_6a1c34dd:
    ...
    mc "문을 두드려서 네 사생활을 존중했고 바로 들어와서 오빠로서의 내 권위를 내세운 거야."


translate korean d16s05_c32c1863:


    mc "문을 두드려고 네 사생활을 존중했고 바로 들어와서 친구로서의 내 권위를 내세운 거야."
...
translate korean d16s05_175cb703:
    ...
    sy "아, 맞다. 있잖니, 면접이라는 건 말이야 돈을 벌기—"


translate korean d16s05_5416ab6b:


    mc "면접이란 게 뭔지는 알아, 이 젠체하는 녀석아."
...
translate korean d16s05_48907d2c:
    ...
    mc "네가 다 큰 거 같아서 그런 느낌이 들었나 봐."


translate korean d16s05_f992d8e8:


    sy "나는 {i}진작에{/i} 다 컸거든요."


translate korean d16s05_12945c16:


    mc "넌 돌도 안 지난 애나 다를 바 없어. 그러니 닥치라구."
...
translate korean d16s05_d52a4038:
    ...
    sy "빈털터리에 이렇게 핫 한 여자로 살 수 없는 거라구."
...
translate korean d16s05_215e1dcd:
    ...
    mc "존나게 전문가처럼 보이는데. 상사 쌍년처럼 쫙 빠졌고 반듯하네."


translate korean d16s05_e02ad694:


    sy "씨발 그거야. 바로 그게 내가 원하는 거라구."


translate korean d16s05_aaa5766b:


    sy "어으, 나 오줌 싸러 간다. 커피를 두 잔 마시면 안 됐는데."


translate korean d16s05_853b737f:


    mc "진심으로 네 카페인 섭취가 걱정되기 시작하는데."


translate korean d16s05_168a01a4:


    sy "이거 아니면 코카인이야. 네가 골라 봐."


translate korean d16s05_69fed768:


    mc "잘 알겠다.{w} 그래서 무슨 일인데?"


translate korean d16s05_c36c5785:


    sy "잘은 놀라, 딱 집어 말하지도 않았고."


translate korean d16s05_d78f366c:


    sy "경찰에서 \"컴퓨터에 관해 잘 아는\" 사람을 구한다는 전단을 본 게 다니까. 뭐 말 그대로겠지"
...
translate korean d16s05_b2805601:
    ...
    sy "어떻게 철면피도 그런 철면치가 다 있냐고. 그냥 \"{i}어떻게 해서{/i} 팰퍼틴이 돌아왔습니다 하면 다냐니까. \" {b}어떻게 해서!?{/b}, {i}{b}어떻게 해서!?{/b}{/i}?"


translate korean d16s05_a5a58593:


    mc "알겠어, 좀 심했다는 건 나도 인정해."


translate korean d16s05_1ec95372:


    mc "그래도 뭐 어느 쪽이냐고 하면, 난 마음에 들었어."


translate korean d16s05_141b24ae:


    sy "세상에, 네 취향은 쓰레기야. 기분이 더러워야 한다구."
...
translate korean d16s05_32c9ed06:
    ...
    mc "간단하게 말하자면 내가 미친 페티시 개지랄을 해서 모은 특별한 동전이 있어. 그걸 사용해서 특정 도전을 넘기거나 짧게 만들 수 있지."


translate korean d16s05_c8325d75:


    mc "그 동전이 충분히 있어서, 뺄 수가 있었어."


translate korean d16s05_27b0f30f:


    sy "허, 음, 대단하네! 드디어 네 좆이 돌아왔구나."
...
translate korean d16s05_1363aa37:
    ...
    sy "음... 오늘 밤엔 이걸로 뭘 할 수 있는지 알아볼 수 있겟네."
...
translate korean d16s05_cb15f7a6:
    ...
    mc "난 지금 보이는 것보다 우리가... {i}더 진한{/i} 사이라는 걸 아니까."
...
translate korean d16s05_ba6638e0:
    ...
    mc "하지만 한 번에 하나씩 천천히 해야 돼."


translate korean d16s05_2d160d94:


    mc "사회는 우리가 하는 일을... 좋게 보지 않을 테니까."


translate korean d16s05_b3d7a39e:


    mc "만약에 누가 우릴 알아보기라도 하면..."


translate korean d16s05_0d1bb08d:


    sy "누가 신경 쓴다고 그래? 엿이나 먹으라 그래."


translate korean d16s05_c63def3f:


    sy "나한텐 네가 소중하고, 내가 알기론, 너한테도 내가 소중해."
...
translate korean d16s05_e3c6a6b7:
    ...
    sy "자기 일이나 신경 쓰지도 못하는 자식한텐 좆이나 까라고 하라고."


translate korean d16s05_7e23f439:


    mc "*낄낄* 나도 그렇게 생각은 하지만, 그래도."


translate korean d16s05_cbabdc91:


    sy "왜? 왜 그냥 우리 맘대로 할 수 없는데?"


translate korean d16s05_b8900318:


    mc "스테이시, 나한텐 네가 소중해. 난 너한테 상처를 주고 싶지 않아."


translate korean d16s05_44581e0a:


    mc "무슨 일이 일어날지는 나도 몰라. 그래도 조심해야 돼."


translate korean d16s05_872f21af:


    sy "*한숨* 나도... 네가 어떻게 하고 싶은진 알겠어."


translate korean d16s05_8ab5ae4f:


    sy "마음엔 안 들지만. 그래도 알겠어."
...
translate korean d16s05_90a342fc:
    ...
    mc "그대에겐 지켜야 할 규칙이라도, 나한텐 아닐지니."


translate korean d16s05_b5fa82b7:


    mc "농담이야. 고마워. 이해해 줘서 고마워."
...
translate korean d16s05_b684d49f:
    ...
    sy "어으, 얼마나 더 기다려야 하는 거야?"


translate korean d16s05_7adf0993:


    mc "이 유명한 정부의 일처리 속도를 직접 보이게 되어 기쁘군요, 신사 숙녀 여러분."
...
translate korean d16s05_91b3f912:
    ...
    mc "아, 진정해. 과장도 참. 말 그대로 15분밖에 안 지났어."
...
translate korean d16s05_0dad097d:
    ...
    sy "15분이면 얼마나 많은 일을 할 수 있는지 알아!?"


translate korean d16s05_82b03971:


    mc "자, 이거 마셔. 입에 뭘 대기라고 하면 덜 불안하겠지."
...
translate korean d16s05_aedb874a:
    ...
    mc "기술 관련된 일은 이거 말고도 잔뜩 있잖아? 인턴 같은 걸 해도 되고."
...
translate korean d16s05_2a31549c:
    ...
    sy "그러니까... 낸 기술 좋아해. 하지만 그 문화는 싫어."


translate korean d16s05_1bbb82ce:


    sy "그래서 기술에 관련되면서도 그 분위기랑은 거리가 먼 일이 하고 싶었어."


translate korean d16s05_b086d03e:


    sy "그리고 아까 말했던 거처럼. 전단을 봤어, 뭔가 괜찮다겠다는 생각을 했고, 그래서 지금 여기에 있는 거야. 아직도 기다리는 중이지만..."


translate korean d16s05_4a258fbd:


    mc "*낄낄* 음, 앞으로 이런 일을 하고 싶은 거야?"


translate korean d16s05_6d530aab:


    sy "씨발 아니지! 난 내 회사를 세울 거야. 50년 동안 다른 사람 밑에서 일하다가 죽지 않을 거라고. 내 운명은 내가 개척할 거라고."
...
translate korean d16s05_382815eb:
    ...
    mc "그러니까, 연방에서 일하는 거잖아. 뒷조사 같은 거나 그런 짓을 할 거라고."


translate korean d16s05_2fc07473:


    sy "그렇긴 하겠지. 그래도 우리가 동네방네에 떠들고 다닌 것도 아닌데."


translate korean d16s05_bdb7e1b3:


    sy "말그대로야... 이 세상에 우리 사이에 관해 아는 사람은 딱 셋이고. 그 중 둘이 우리야.{w} 난 괜찮다고 봐."
...
translate korean d16s05_d6853969:
    ...
    mc "리사? 난데없이 왜 리사에 관해서 묻는 거야?"


translate korean d16s05_2817129d:


    sy "둘이서 데이트 했었잖아? 내가 끼어들어서 망친 거."


translate korean d16s05_d9225ff6:


    sy "데이트 전엔 어땠어? 이제 둘이 진지한 사이야? 어떻게 됐어? 자세히 좀 말해 봐."


translate korean d16s05_1dc0a15b:


    mc "어... 음, 글쎄? 우리 가까워지고 있어. 그리고 계속 리사를 보고 싶어."


translate korean d16s05_211e3808:


    sy "...거 참 이렇게 무미건조한 대답은 처음 듣는데."
...
translate korean d16s05_3a799a88:
    ...
    mc "그건 그렇고 왜 리사한텐 그렇게 관심이 많은 거야?"


translate korean d16s05_3614f832:


    sy "누구라고 리사한테 흥미가 없겠어? 너 리사를 {i}보긴{/i} 한 거야?"


translate korean d16s05_ab33ffd2:


    sy "거기에 리사의 배려심 넘치는 돔 분위기는 흠 잡을 데가 없다구."
...
translate korean d16s05_da626596:
    ...
    mc "내가 말할 수 있는 말은 전부 괜찮다는 게 다야."


translate korean d16s05_6abc3f50:


    mc "흥미진진한 이야기가 있든 없든 리사랑 내 사이의 일로 남을 거구. 이제 끝."
...
translate korean d16s05_f76aedcb:
    ...
    "여성" "스테이시 영? 스테이시 영 여기 계십니까?"


translate korean d16s05_7e30f1b5:


    "여성" "스테이스 브런? 스테이시 브런 여기 계십니까?"


translate korean d16s05_b8161c52:


    sy "아, 젠장. 어, 네! 저 여기 있어요."
...
translate korean d16s05_4f9e374a:
    ...
    sy "아, 세상에, 좋아. 난 할 수 있어. 행운을 빌어 줘."


translate korean d16s05_ee40ef6b:


    mc "야, 넌 내 자랑이야. 넌 할 수 있어."
...
translate korean d16s05_7bdf47c4:
    ...
    sy "아니, 진짜로, 씨발 요즘 세상에 누가 마약 검사를 하냐구!?"


translate korean d16s05_6ea7d144:


    sy "인생은 좆 같아. 우린 이 좆 같은 세상을 살아가려면 대마 정도는 있어야 한다구."


translate korean d16s05_2905d6b4:


    sy "그 등신 같은 약물 검사를 하는 자식들은 엿이나 먹으라 그래."
...
translate korean d16s05_407cebc9:
    ...
    sy "사람 보는 앞에서 자기한테 안 묻히고 컵에 싸려면 17개의 다양한 각도로 몸을 숙여야 한단 말이지."


translate korean d16s05_069d84bc:


    sy "아, 거기에 금상첨화로 염병할 거짓말 탐지기까지!? 그냥 자료 입력하는 일인데!?"


translate korean d16s05_a3182c70:


    sy "내가 뭘 할 거라고 생각하는 거야? 위키릭스 2: 전기 부걸루?"
...
translate korean d16s05_d0356af7:
    ...
    sy "맹세할 수도 있어. 이건 내 평생 가장 멍청한 지싱야."
...
translate korean d16s05_0da34214:
    ...
    sy "글쎄... 모르겠어. 안정적인 일이고 언제든지 할 수 있겠지."


translate korean d16s05_4967428d:


    sy "급료는... 괜찮을 거 같아. 살 수 있을 정도."


translate korean d16s05_a6c59dd0:


    sy "모르겠다. 제대로 생각 좀 해 봐야겠어."


translate korean d16s05_b6ac60e5:


    sy "어으, 어서 내 회사 세우고 싶다."


translate korean d16s05_800d7353:


    sy "난 뭐든지, 언제든지 할 수 있어. 누구도 나한테 찍소리도 못해."
...
translate korean d16s05_12cb10ae:
    ...
    mc "이번 달 말엔 한 몫은 충분히 할 수 있겠지."


translate korean d16s05_3b7b82e8:


    sy "어으, 면접이 이렇게 지치는 줄은 몰랐어."
...
translate korean d16s05_e0a106af:
    ...
    sy "좋아. 너도 알겠지만 난 쿠키 도우 아이스크림 곡 먹고 싶네."


translate korean d16s05_3fa818ba:


    mc "쿠키 도우? 그러다가 너 살모넬라든 뭐든 걸린다."
