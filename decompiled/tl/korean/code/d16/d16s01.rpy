...
translate korean d16s01_66e01943:
    ...
    sy "아, 젠장. 단박에 컴파일이 됐잖아! 이거 좋은 징조가 아닌데..."
...
translate korean d16s01_a9a0ec0c:
    ...
    sy "99마리의 악랄한 버그가 코드에 있으면, 99마리의 악랄한 버그가 있는 거야. 한 마리를 잡고, 고쳤다 싶으면, 110마리의 알랄한 버그가 생기고..."
...
translate korean d16s01_f360d4e1:
    ...
    arj "어이, 목소리 좀 낮춰야 돼. [mcname] 얘는 아직 꿈나라 속이라구."
...
translate korean d16s01_8d0c707d:
    ...
    sy "하늘을 찬양하라, 마침내 작동하네."


translate korean d16s01_71399fd5:


    sy "아, 저 모습 좀 봐. 주인공께서도 일어나셨군. 딱 맞추기도 했네."
...
translate korean d16s01_47876170:
    ...
    arj "자기엔 너무 열이 돌아서 말이야. 그래서 이 기력을 작업에 쏟기로 했지요."


translate korean d16s01_0f2e2912:


    sy "작업명: {b}페티시-로케이터-추적-종결자™{/b}."


translate korean d16s01_ce907ec8:


    arj "... 그 명칭에는 연구 개발이 좀 필요하겠다."


translate korean d16s01_f6e6aa80:


    arj "하드웨어 부문에서도 작업은 끝났어."


translate korean d16s01_ed59ad4d:


    arj "전력 소모 문제도 고쳤어. 리튬-이온 전지를 이어 붙여서 전력 공급을 하게 만들었지."


translate korean d16s01_b6fc2dde:


    arj "한 번 완충하면 일주일은 갈 거야. {i}그래서{/i} 엄청 큰 전지 끌고 다닐 필욘 없답니다."


translate korean d16s01_ddc04b62:


    sy "36.72%%의 확률로 얼굴을 날려 버릴 순 있겠지만요!"


translate korean d16s01_e4546705:


    arj "나 스스로도 자랑스럽다고 할 수 있을 정도라구."
...
translate korean d16s01_f9b6f25d:
    ...
    mc "페키시 로케이터를 처리한 다음엔 실제 판매용으로 만들어도 되겠다."


translate korean d16s01_132b1d8b:


    arj "흠... 그럴 수도 있겠지만, 지금은 반푼이야."
...
translate korean d16s01_b2e194ca:
    ...
    sy "비법 양념은 바로 여기에 있답니다."


translate korean d16s01_a01d0df1:


    sy "이 귀염둥이가 페티시-로케이터-추적-종결자™를 진짜 네트워크처럼 위장시켜 줄 거야."
...
translate korean d16s01_5bb29158:
    ...
    sy "네 휴대폰을 페티시-로케이터-추적-종결자™ 네트워크에 연결한 거지."


translate korean d16s01_d53b0e53:


    sy "기본적으로 페티시-로케이터-추적-종결자™는 인터넷 연결과 사용을 가능하게 해 주는 기기야. 중요한 점은 모든 수송신 내역을 내부에 기록한다는 점이지만."


translate korean d16s01_0b0f857f:


    sy "쉽게 말하면 페티시 로케이터를 통해 송수신되는 데이터가 있으면, 페티시-로케이터-추적-종결자™가 그 정보를 몰래 기록한다는 거지."


translate korean d16s01_34351075:


    sy "페티시 로케이터의 측면에선 차이를 전혀 알 수 없어. 그저 정상적인 네트워크로 보이니까. 이상한 건 포착할 수 없다는 거지."


translate korean d16s01_a2a49102:


    mc "대단한데. 그러면 내가 할 일은 페티시 로케이터에 접속하기만 하면 된다는 거야. 그러면 우리가 그 서버 위치를 알 수 있고?"
...
translate korean d16s01_78aacb29:
    ...
    arj "어젯밤에 내 휴대폰으로 해 봤어.{w} 안 먹히더라구."
...
translate korean d16s01_eb6db404:
    ...
    arj "페티시 로케이터 네트워크의 모든 패킷은 암호화되어 있어."
...
translate korean d16s01_730b04ca:
    ...
    mc "뒤에 있는 인간은 누가 염탐하는 게 {i}정말{/i} 싫었나 보네."


translate korean d16s01_9c483341:


    sy "글쎄다. 의도한 건지 아닌 건진 모르겠어. 그 인간이 그냥 최신 네워크 표준을 따른 걸 수도 있으니까. 여하튼 그건 중요한 게 아냐."


translate korean d16s01_a278c733:


    mc "그러면 어떻게 해야 돼? 그냥 실패인 거야?"


translate korean d16s01_f626f797:


    sy "헹, 우리 {i}좀{/i} 믿으려고 해 봐라, [mcname]."
...
translate korean d16s01_b1ae83f7:
    ...
    sy "요컨대, 페티시-로케이터-추적-종결자™는 페티시 로케이터의 모든 송수신 내역을 조사하면서, 동시에 데이터를 복호화해."


translate korean d16s01_1951407e:


    sy "그런데 문제는 우리가 시도하는 방식이 주먹구구식이라는 거지... 솔직히 말하자면 빠르진 않은 거야."
...
translate korean d16s01_3a0819eb:
    ...
    arj "스테이시가 하는 말은 페티시 로케이터의 암호 깨려면 엄청난 데이터가 필요한데, 시간이 얼마나 걸릴지 모른다는 말이지."
...
translate korean d16s01_cf05969f:
    ...
    sy "주먹구구식은 일일이 암호를 대조해야 돼서 시간이 많이 걸려. 그래서 해독 과정에 드는 시간도 예측할 수 없다는 거야."


translate korean d16s01_3bc70fb6:


    sy "페티시 로케이터를 열자마자 암호가 풀릴 수도 있고, 몇달 걸릴 수도 있어..."
...
translate korean d16s01_7b74d818:
    ...
    sy "맞아. 그치만 암호를 깨는 데 엄청 시간이 들진 않겠지."


translate korean d16s01_515e4cc2:


    sy "그래도 불활실하다는 점이 좆 같지만."
...
translate korean d16s01_e2008202:
    ...
    mc "우린 진짜 먹힐 방법을 준비한 거잖아."


translate korean d16s01_e31627a6:


    mc "그러니 우리가 할 수 있는 한 해 봐야지."


translate korean d16s01_9fd9f3f2:


    mc "말이 나왔으니 말인데, 어떤 종류의 데이터가 필요한 거야?"


translate korean d16s01_5002f737:


    mc "그냥 앱을 계속 열고 닫는다고 해서 되는 건 아닐 거 아냐?"


translate korean d16s01_dfb80f38:


    sy "그래, 아냐. 여러 종류의 데이터가 필요해."


translate korean d16s01_42ddb90f:


    sy "같은 종류의 데이터를 연거푸 구하는 건 도움이 안 돼."


translate korean d16s01_0733307d:


    arj "그러니까 도전도 완료하고, 점수로 뭘 사기도 하고 해 봐. 페티시 로케이터랑 가능한 많이 상호작용을 하면 될 거야."


translate korean d16s01_4898b166:


    arj "점수가 많을수록 암호를 깰 가능성도 늘어난다는 거지."


translate korean d16s01_ac205b97:


    mc "알겠어. 음, 그러니까 꼭 나쁜 것 같진 않네."
...
translate korean d16s01_ae03c62f:
    ...
    mc "자지 틀만 차고 돌아다니지 않으면 일이 존나게 쉬워질 텐데."


translate korean d16s01_05da6f3d:


    sy "그 작업을 하는데... 쓸 수 있는 {i}도구{/i}는 잔뜩 있을 거 아냐."


translate korean d16s01_577fe339:


    arj "그렇지. 그러니까 우린 이 장치를 굴러가게 두고, 페티시 로케이터에 관해서 다른 접근이 가능한지도 알아 보면 되는 거지."
