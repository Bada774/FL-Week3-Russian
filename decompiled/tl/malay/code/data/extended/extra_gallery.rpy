translate malay strings:
    ...
    new "Buka pengkahiran ke-19 yang tersembunyi"


    old "02. GG EZ Videogame"
    new "02. Senang Sangat"


    old "Get a high score in the minigame"
    new "Dapatkan markah tinggi dalam permainan mini"


    old "03. Somebody that I Used to Know"
    new "03. \"Somebody that I Used to Know\""


    old "Unlock Lydia's music video"
    new "Buka kunci video muzik Lydia"
    ...
    new "Buka 18 pengakhiran"


    old "05. Front Nine"
    new "05. Sembilan Depan"


    old "Unlock 9 endings"
    new "Buka 9 pengakhiran"


    old "06. What a Wild Ride"
    new "06. Perjalanan Liar"


    old "Complete all 6 base endings"
    new "Lengkapkan kesemua 6 pengkahiran asas"
    ...
    new "Lihat semua yang awak tak nak"
    ...
    new "Lihat semua kod pintu rahsia"


    old "09. In the Beginning..."
    new "09. Pada permulaan..."


    old "Make it all the way to Day 15"
    new "Jadikan ia sehingga Hari ke-15"


    old "10. Release the Kraken"
    new "10. Lepaskan Kraken"


    old "Get free from the cage"
    new "Bebas dari sangkar"
    ...
    new "Musnahkan apl itu... atau tak"
    ...
    new "Pergi ke perbicaraan mahkamah"
    ...
    new "Selesaikan kali pertama anda"


    old "15. Miss White, with the Candlestick"
    new "15. Cik Putih, dengan Batang Lilin"


    old "Discover who is behind the app on the LC path"
    new "Temui siapa yang berada di belakang apl di laluan LC"
    ...
    new "Temui siapa yang berada di belakang apl di laluan NTR"


    old "17. Real Genius"
    new "17. Genius Sebenar"


    old "Finish final exams perfectly"
    new "Habiskan peperiksaan akhir dengan sempurna"


    old "18. Keep Pounding That Gavel"
    new "18. Teruskan Menumbuk Itu"


    old "Get both scenes with the judge"
    new "Dapatkan kedua-dua adegan dengan hakim"


    old "19. What Are Friends For"
    new "19. Kawan untuk apa"


    old "Knock up your best friend's gal"
    new "Kongkek perempuan kawan baik awak"


    old "20. Are You Not Entertained"
    new "20. Adakah Anda Tak Terhibur"


    old "Play all three scenes at the amusement park"
    new "Mainkan ketiga-tiga adegan di taman hiburan"


    old "21. Oh, the Humanity!"
    new "21. Oh, Kemanusiaan!"


    old "Play all three versions of Lyssa's Wednesday scenes"
    new "Mainkan ketiga-tiga versi adegan Rabu Lyssa"


    old "22. Why Would You Do That"
    new "22. Kenapa Awak Buat Itu"


    old "Don't remove the cage, even though you could"
    new "Jangan keluar dari sangkar, walaupun anda boleh"


    old "23. Fantastic Fivesome"
    new "23. Hebat Berlima"


    old "Maria and some friends are very thankful"
    new "Maria dan beberapa rakan sangat berterima kasih"


    old "24. Craving Pickles and Ice-cream"
    new "24. Mengidam Acar dan Aiskrim"


    old "Impregnate every possible person in the queen's harem"
    new "Hamilkan setiap orang yang mungkin di harem ratu"


    old "25. I Need Sexual Healing"
    new "25. Saya Perlukan Penyembuhan Seksual"


    old "Helped all 3 couples at the ski resort"
    new "Tolong semua 3 pasangan di resort ski"


    old "26. This Magic Moment"
    new "26. Detik Ajaib Ini"


    old "Went on the ferris wheel with Daisy"
    new "Naik roda ferris dengan Daisy"


    old "27. May I panic now, Mistress?"
    new "27. Bolehkah saya panik sekarang, Puan?"


    old "Braved the funhouse with Dahlia"
    new "Beranikan diri dengan Dahlia"


    old "28. Fifty-Five Foot Club"
    new "28. Kelab Lima Puluh Lima Kaki"


    old "Join Polly and Nora on the ferris wheel"
    new "Sertai Polly dan Nora menaiki roda ferris"


    old "29. That Was Cathartic... for Them"
    new "29. Itu adalah Katartik... untuk Mereka"


    old "Fix Dahlia and Samiya's relationship"
    new "Betulkan hubungan Dahlia dan Samiya"


    old "HIGH SCORE :\n[persistent.minigame_max_score]"
    new "MARKAH TERTINGGI :\n[persistent.minigame_max_score]"


    old "HOW MANY ENDINGS HAVE YOU UNLOCKED?"
    new "BERAPA BANYAK PENGAKHIRAN YANG ANDA DAPAT?"
    ...
    new "ANDA PERLU NAIKKAN NOMBOR ITU.\nITU ADALAH NOMBOR ROKIE!"


    old "6 endings\naren't enough.\nI need all 18 now!!!"
    new "6 pengakhiran\ntak mencukupi.\nSaya perlukan semua 18 sekarang!!!"


    old "{b}CHANGE MY MIND{/b}"
    new "{b}UBAH FIKIRAN SAYA{/b}"


    old "I WANT TO KEEP\nFETISH LOCATOR"
    new "SAYA NAK KEKALKAN\nFETISH LOCATOR"


    old "TO MAKE SURE NO ONE\nWILL BE BLACKMAILED"
    new "UNTUK MEMASTIKAN TIADA SEORANG\nAKAN DIPERAS UGUT"


    old "YOU'RE GOING TO USE\nIT FOR GOOD, RIGHT?"
    new "ANDA AKAN MENGGUNAKANNYA\nIUNTUK KEBAIKAN, KAN?"
    ...
    new "PENGAKHIRAN PERTAMA\nDARI 18 JUMLAH PENGAKHIRAN"


    old "IS THAT A REAL ENDING?"
    new "ADAKAH ITU PENGAKHIRAN YANG SEBENAR?"


    old "TRADE OFFER"
    new "TAWARAN PERDAGANGAN"
