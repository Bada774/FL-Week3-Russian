screen prologue_recap_choice():
    ...
    frame:
        ...
        vbox:
            xalign 0.5
            null height 10
            text _("Do you want to watch the recap of previous weeks?")
            null height 150
        vbox:
            xalign 0.5
            spacing 30
            hbox:
                ...
                vbox:
                    ...
                    text _("Watch the Recap") style_prefix "name" xalign 0.5
                vbox:
                    xsize 300
                    spacing 10
                    imagebutton:
                        ...
                        action Jump("d15s01")
                    text _("Play Week-3") style_prefix "name" xalign 0.5
